...
print("DONE.")
# ==========================================
# TODO: - beim Transformieren darf zw. : und
#         ; kein Leerraum entfernt werden
#       - 
# ==========================================


def transform_css(file_from:Path,
                file_to:Path="./Layout/css_string.css",
...
def insert_style(css:Path,
                 variables:Path|None,
                 key:str|int=0) -> str|None:
    # prevent repetitions:
    k = str(key)
    if k in state:
        return None         # evtl muss css in cache
